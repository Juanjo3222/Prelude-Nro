...
"51.178.29.194 storage.hac.lp1.scsi.srv.nintendo.net\n"
    ...
    "# ATTENTION: pas de wildcard *.srv.nintendo.net ici pour deux raisons:\n"
    "# 1) api.hac.lp1.ctest.srv.nintendo.net (conntest browser FW 18.0+, requis\n"
    "#    pour ouvrir le browser) ne doit PAS etre redirige -> sinon browser\n"
    "#    refuse de s'ouvrir (\"Función no disponible\").\n"
    "# 2) Les hotes critiques (val, god, dauth, storage, scsi) sont deja listes\n"
    "#    explicitement ci-dessus.\n"
    "# Les sous-domaines srv.nintendo.net non listes resolvent vers le vrai\n"
    "# Nintendo, ce qui est desire pour les tests de connectivite.\n"
    "# Entrees explicites pour les hotes .nintendo.net critiques non couverts\n"
    "# ci-dessus.\n"
